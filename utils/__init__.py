...
from .bones import new_bone, copy_bone_simple, _legacy_copy_bone, flip_bone, put_bone, _legacy_make_nonscaling_child
...
copy_bone = _legacy_copy_bone
make_nonscaling_child = _legacy_make_nonscaling_child
